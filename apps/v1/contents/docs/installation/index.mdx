...
<Note title="Note" type="info">
	You can configure or add elements to your project manually with CLI options.
	See the [references](references?from=installation).
</Note>
...
<Note title="Attention" type="danger">
